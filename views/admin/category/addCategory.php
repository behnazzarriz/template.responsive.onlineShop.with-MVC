            ...
            <div class="container-fluid">
                ...
                <form action="adminCategory/addCategory" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control custom-select" id="Subset" name="parent" autocomplete="off">
                            <option>select subset</option>
                            <?php
                            foreach ($categories as $category){
                                ?>

                                <option value="<?=$category['id']?>" <?php if($category['id']==$parentId){ echo 'selected';}?>>
                                    <?=$category['title']?>
                                </option>
                            <?php
                            }
                  ...
                  <!--  <button class="btn btn-primary">submit</button>-->
                    <a class="btn btn-primary white" onclick="submitForm();">
                        submit
                    </a>
                    <script>
                        function submitForm() {
