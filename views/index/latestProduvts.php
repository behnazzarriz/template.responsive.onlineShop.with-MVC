<div class="carousel slide multi-item-carousel" data-ride="carousel" id="multi_item_3">
    ...
    <a class="carousel-control-prev" href="#multi_item_3" role="button" data-slide="prev">
        <i class="fa fa-chevron-left"></i>
    </a>
    <a class="carousel-control-next" href="#multi_item_3" role="button" data-slide="next">
